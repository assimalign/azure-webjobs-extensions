...
namespace Assimalign.Azure.WebJobs.Bindings.OData.Builder
{
    ...
    public class FunctionConfiguration : OperationConfiguration
    {
        ...
        /// </summary>
        public FunctionConfiguration HasFunctionLink(Func<ODataResourceContext, Uri> functionLinkFactory, bool followsConventions)
        {
        ...
        public Func<ODataResourceContext, Uri> GetFunctionLink()
        {
