...
namespace Assimalign.Azure.WebJobs.Bindings.OData.Builder
{
    ...
    public class NavigationSourceLinkBuilderAnnotation
    {
        ...
        public NavigationSourceLinkBuilderAnnotation(IEdmNavigationSource navigationSource, IEdmModel model)
        {
            ...
            {
                Func<ODataResourceContext, IEdmNavigationProperty, Uri> navigationLinkFactory =
            ...
            Func<ODataResourceContext, Uri> selfLinkFactory =
        ...
        /// <summary>
        /// Constructs the <see cref="EntitySelfLinks" /> for a particular <see cref="ODataResourceContext" /> and <see cref="ODataMetadataLevel" />.
        /// </summary>
        public virtual EntitySelfLinks BuildEntitySelfLinks(ODataResourceContext instanceContext, ODataMetadataLevel metadataLevel)
        {
        ...
        /// <summary>
        /// Constructs the IdLink for a particular <see cref="ODataResourceContext" /> and <see cref="ODataMetadataLevel" />.
        /// </summary>
        public virtual Uri BuildIdLink(ODataResourceContext instanceContext, ODataMetadataLevel metadataLevel)
        {
        ...
        internal Uri BuildIdLink(ODataResourceContext instanceContext)
        {
            return BuildIdLink(instanceContext, ODataMetadataLevel.FullMetadata);
        }

        /// <summary>
        /// Constructs the EditLink URL for a particular <see cref="ODataResourceContext" /> and <see cref="ODataMetadataLevel" />.
        /// </summary>
        public virtual Uri BuildEditLink(ODataResourceContext instanceContext, ODataMetadataLevel metadataLevel, Uri idLink)
        {
            if (instanceContext == null)
            {
                throw Error.ArgumentNull("instanceContext");
        ...
        internal Uri BuildEditLink(ODataResourceContext instanceContext)
        {
            return BuildEditLink(instanceContext, ODataMetadataLevel.FullMetadata, null);
        }

        /// <summary>
        /// Constructs a ReadLink URL for a particular <see cref="ODataResourceContext" /> and <see cref="ODataMetadataLevel" />.
        /// </summary>
        public virtual Uri BuildReadLink(ODataResourceContext instanceContext, ODataMetadataLevel metadataLevel, Uri editLink)
        {
            if (instanceContext == null)
            {
                throw Error.ArgumentNull("instanceContext");
        ...
        internal Uri BuildReadLink(ODataResourceContext instanceContext)
        {
            return BuildReadLink(instanceContext, ODataMetadataLevel.FullMetadata, null);
        }

        /// <summary>
        /// Constructs a NavigationLink for a particular <see cref="ODataResourceContext" />, <see cref="IEdmNavigationProperty" /> and <see cref="ODataMetadataLevel" />.
        /// </summary>
        public virtual Uri BuildNavigationLink(ODataResourceContext instanceContext, IEdmNavigationProperty navigationProperty, ODataMetadataLevel metadataLevel)
        {
            if (instanceContext == null)
            {
                throw Error.ArgumentNull("instanceContext");
        ...
        internal Uri BuildNavigationLink(ODataResourceContext instanceContext, IEdmNavigationProperty navigationProperty)
        {
            if (instanceContext == null)
            {
                throw Error.ArgumentNull("instanceContext");
