...
{
    public sealed class TableAccessorOptions
    {
        /// <summary>
        ...
        /// <summary>
        /// Set the Table Client options for all bindings.
        /// </summary>
        public TableClientOptions TableClientOptions { get; set; } = new TableClientOptions();
