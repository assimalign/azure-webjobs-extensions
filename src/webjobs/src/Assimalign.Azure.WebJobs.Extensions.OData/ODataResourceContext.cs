...
namespace Assimalign.Azure.WebJobs.Bindings.OData
{
    ...
    using Assimalign.Azure.WebJobs.Bindings.OData.Formatters;
    using Assimalign.Azure.WebJobs.Bindings.OData.Formatters.Deserialization;
    using Assimalign.Azure.WebJobs.Bindings.OData.Formatters.Serialization;
    using Assimalign.Azure.WebJobs.Bindings.OData.Abstractions;
    using Assimalign.Azure.WebJobs.Bindings.OData.Query.Expressions;

    /// <summary>
    /// An instance of <see cref="ODataResourceContext"/> gets passed to the self link (
    ...
    /// </summary>
    public partial class ODataResourceContext
    {
        private object _resourceInstance;

        /// <summary>
        /// Initializes a new instance of the <see cref="ODataResourceContext"/> class.
        /// </summary>
        public ODataResourceContext()
        {
        ...
        public ODataResourceContext(ODataSerializerContext serializerContext, IEdmStructuredTypeReference structuredType, object resourceInstance)
            : this(serializerContext, structuredType, AsEdmResourceObject(resourceInstance, structuredType, serializerContext.Model))
        {
        }

        private ODataResourceContext(ODataSerializerContext serializerContext, IEdmStructuredTypeReference structuredType, IEdmStructuredObject edmObject)
        {
        ...
        public object GetPropertyValue(string propertyName)
        {
            if (EdmObject == null)
            {
                throw Error.InvalidOperation(SRResources.EdmObjectNull, typeof(ODataResourceContext).Name);
            }
