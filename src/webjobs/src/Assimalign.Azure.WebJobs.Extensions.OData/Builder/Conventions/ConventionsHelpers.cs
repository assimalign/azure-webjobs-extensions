...
namespace Assimalign.Azure.WebJobs.Bindings.OData.Builder.Conventions
{
    ...
    {
        public static IEnumerable<KeyValuePair<string, object>> GetEntityKey(ODataResourceContext resourceContext)
        {
        ...
        private static object GetKeyValue(IEdmProperty key, ODataResourceContext resourceContext)
        {
        ...
        public static string GetEntityKeyValue(ODataResourceContext resourceContext)
        {
            Contract.Assert(resourceContext != null);
            Contract.Assert(resourceContext.StructuredType != null);
            Contract.Assert(resourceContext.EdmObject != null);
        ...
        private static string GetUriRepresentationForKeyValue(IEdmProperty key, ODataResourceContext resourceContext)
        {
            Contract.Assert(key != null);
            Contract.Assert(resourceContext != null);
