...
namespace Assimalign.Azure.WebJobs.Bindings.OData.Builder
{
    ...
    {
        private Func<ODataResourceContext, Uri> _linkFactory; // bound to entity
        ...
        /// </param>
        public OperationLinkBuilder(Func<ODataResourceContext, Uri> linkFactory, bool followsConventions)
        {
            if (linkFactory == null)
            {
        ...
        /// </summary>
        internal Func<ODataResourceContext, Uri> LinkFactory
        {
        ...
        public virtual Uri BuildLink(ODataResourceContext context)
        {
