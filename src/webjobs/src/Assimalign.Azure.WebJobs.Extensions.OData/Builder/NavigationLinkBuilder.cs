...
namespace Assimalign.Azure.WebJobs.Bindings.OData.Builder
{
    ...
    public class NavigationLinkBuilder
    {
        ...
        public NavigationLinkBuilder(Func<ODataResourceContext, IEdmNavigationProperty, Uri> navigationLinkFactory, bool followsConventions)
        {
        ...
        /// </summary>
        public Func<ODataResourceContext, IEdmNavigationProperty, Uri> Factory { get; private set; }
