...
namespace Assimalign.Azure.WebJobs.Bindings.OData.Formatters
{
    public class ODataClrTypeCache
    {
        private ConcurrentDictionary<Type, IEdmTypeReference> _clrToEdmTypeCache = new ConcurrentDictionary<Type, IEdmTypeReference>();
        private ConcurrentDictionary<EdmTypeCacheItem, Type> _edmToClrTypeCache = new ConcurrentDictionary<EdmTypeCacheItem, Type>(new EdmTypeCacheItemComparer());
