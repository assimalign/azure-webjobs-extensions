...
{
    internal class ODataPropertyHelper
    {
        private static ConcurrentDictionary<Type, ODataPropertyHelper[]> _reflectionCache = new ConcurrentDictionary<Type, ODataPropertyHelper[]>();
        ...
        public ODataPropertyHelper(PropertyInfo property)
        {
