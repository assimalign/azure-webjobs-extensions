...
namespace Assimalign.Azure.WebJobs.Bindings.OData.Builder
{
    ...
    public static class LinkGenerationHelpers
    {
        ...
        /// </summary>
        /// <param name="resourceContext">The <see cref="ODataResourceContext"/> representing the entity for which the self link needs to be generated.</param>
        ...
        public static Uri GenerateSelfLink(this ODataResourceContext resourceContext, bool includeCast)
        {
            ...
            {
                throw Error.Argument("resourceContext", SRResources.UrlHelperNull, typeof(ODataResourceContext).Name);
            }
        ...
        /// navigation property.
        /// </summary>
        /// <param name="resourceContext">The <see cref="ODataResourceContext"/> representing the entity for which the navigation link needs to be generated.</param>
        ...
        public static Uri GenerateNavigationPropertyLink(this ODataResourceContext resourceContext,
        ...
        /// </summary>
        /// <param name="resourceContext">The <see cref="ODataResourceContext"/> representing the entity for which the action link needs to be generated.</param>
        /// <param name="action">The action for which the action link needs to be generated.</param>
        /// <returns>The generated action link following OData URL conventions.</returns>
        public static Uri GenerateActionLink(this ODataResourceContext resourceContext, IEdmOperation action)
        {
            if (resourceContext == null)
            {
                throw Error.ArgumentNull("resourceContext");
        ...
        internal static Uri GenerateActionLink(this ODataResourceContext resourceContext,
        ...
        internal static Uri GenerateActionLink(this ODataResourceContext resourceContext, string bindingParameterType,
            string actionName)
        {
            Contract.Assert(resourceContext != null);
            if (resourceContext.NavigationSource is IEdmContainedEntitySet)
        ...
        /// represented by <paramref name="resourceContext"/>.
        /// </summary>
        /// <param name="resourceContext">The <see cref="ODataResourceContext"/> representing the entity for which the function link needs to be generated.</param>
        /// <param name="function">The function for which the function link needs to be generated.</param>
        /// <returns>The generated function link following OData URL conventions.</returns>
        public static Uri GenerateFunctionLink(this ODataResourceContext resourceContext, IEdmOperation function)
        {
            if (resourceContext == null)
            {
                throw Error.ArgumentNull("resourceContext");
        ...
        internal static Uri GenerateFunctionLink(this ODataResourceContext resourceContext,
        ...
        internal static Uri GenerateFunctionLink(this ODataResourceContext resourceContext, string bindingParameterType,
            string functionName, IEnumerable<string> parameterNames)
        {
        ...
        internal static IList<ODataPathSegment> GenerateBaseODataPathSegments(this ODataResourceContext resourceContext)
        {
        ...
        private static void GenerateBaseODataPathSegmentsForEntity(
            this ODataResourceContext resourceContext,
            IList<ODataPathSegment> odataPath)
        {
            // If the navigation is not a singleton we need to walk all of the path segments to generate a
            // contextually accurate URI.
