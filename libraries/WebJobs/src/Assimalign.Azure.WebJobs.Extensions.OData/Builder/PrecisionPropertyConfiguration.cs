...
namespace Assimalign.Azure.WebJobs.Bindings.OData.Builder
{
    ...
    public class PrecisionPropertyConfiguration : PrimitivePropertyConfiguration
    {
        ...
        /// <summary>
        /// Get or set the maximum number of digits allowed in the propertyâ€™s value for decimal property.
        /// Get or set the number of decimal places allowed in the seconds portion of the propertyâ€™s value for temporal property.
        /// </summary>
