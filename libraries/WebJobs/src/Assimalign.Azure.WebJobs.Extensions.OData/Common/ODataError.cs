...
namespace Assimalign.Azure.WebJobs.Bindings.OData.Common
{
    internal static class ODataError
    {
        ...
        {
            return new ArgumentException(ODataError.Format(messageFormat, messageArgs));
        }
        ...
        {
            return new ArgumentException(ODataError.Format(messageFormat, messageArgs), parameterName);
        }
        ...
        {
            return new ArgumentException(ODataError.Format(CommonWebApiResources.ArgumentInvalidHttpUriScheme, actualValue, HttpScheme, HttpsScheme), parameterName);
        }
        ...
        {
            return new ArgumentException(ODataError.Format(CommonWebApiResources.ArgumentInvalidAbsoluteUri, actualValue), parameterName);
        }
        ...
        {
            return new ArgumentException(ODataError.Format(CommonWebApiResources.ArgumentUriHasQueryOrFragment, actualValue), parameterName);
        }
        ...
        {
            return new ArgumentNullException(parameterName, ODataError.Format(messageFormat, messageArgs));
        }
        ...
        {
            return ODataError.Argument(parameterName, CommonWebApiResources.ArgumentNullOrEmpty, parameterName);
        }
        ...
        {
            return new ArgumentOutOfRangeException(parameterName, actualValue, ODataError.Format(messageFormat, messageArgs));
        }
        ...
        {
            return new ArgumentOutOfRangeException(parameterName, actualValue, ODataError.Format(CommonWebApiResources.ArgumentMustBeGreaterThanOrEqualTo, minValue));
        }
        ...
        {
            return new ArgumentOutOfRangeException(parameterName, actualValue, ODataError.Format(CommonWebApiResources.ArgumentMustBeLessThanOrEqualTo, maxValue));
        }
        ...
        {
            return new KeyNotFoundException(ODataError.Format(messageFormat, messageArgs));
        }
        ...
        internal static ObjectDisposedException ObjectDisposed(string messageFormat, params object[] messageArgs)
        {
            ...
            return new ObjectDisposedException(null, ODataError.Format(messageFormat, messageArgs));
        }
        ...
        {
            return new OperationCanceledException(ODataError.Format(messageFormat, messageArgs));
        }
        ...
        {
            return new InvalidOperationException(ODataError.Format(messageFormat, messageArgs));
        }
        ...
        {
            return new InvalidOperationException(ODataError.Format(messageFormat, messageArgs), innerException);
        }
        ...
        {
            return new NotSupportedException(ODataError.Format(messageFormat, messageArgs));
        }
    }
}
